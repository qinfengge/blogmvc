...
<body>
	...
	<div id="login">
		<form method="post" action="user?opr=register">
			<table border="1" id="tlogin">
				<tr>
					<td colspan="2" align="center"><img id="logo" alt="" src="music/LogoSample_ByTailorBrands.jpg">
				</tr>
				<tr>
					<td colspan="2" align="center">秦风戈博客欢迎您注册！
				</tr>
				<tr>
					<td>用户名:
					<td><input type="text" name="reg-userName">
				</tr>
				<tr>
					<td>密码:
					<td><input type="password" name="reg-passwd" id="pwd1">
				</tr>
				<tr>
					<td>确认密码:
					<td><input type="password" name="regYes-passwd" id="pwd2">
				</tr>
				<tr>
	...
	<a href="mlogin.jsp" style="color: white;">已经有账号了？点击登录</a>
	<p>
	<%
...
$(document).ready(function(){
	$("#pwd1").focus(function () {
		$("#logo").attr("src","music/3b87e950352ac65c15871c9bf7f2b21192138a53.jpg");
	});
	$("#pwd2").focus(function () {
		$("#logo").attr("src","music/3b87e950352ac65c15eb1c9bf7f2b21192138a6f.jpg");
	});
})
</script>
</body>
